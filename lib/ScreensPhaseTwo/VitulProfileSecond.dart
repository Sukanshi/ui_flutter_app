...
class VitulProfileSecond extends StatefulWidget {
  static const String id = 'VitulProfileSecond';
  @override
  _VitulProfileSecondState createState() => _VitulProfileSecondState();
}

class _VitulProfileSecondState extends State<VitulProfileSecond> {
  ...
  static final kBadal = Text('BADAL THUKRAL',
    style: TextStyle(
      color: Colors.black,
