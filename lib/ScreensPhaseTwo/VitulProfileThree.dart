...
class VitulProfileThree extends StatefulWidget {
  static const String id = 'VitulProfileThree';
  @override
  _VitulProfileThreeState createState() => _VitulProfileThreeState();
}

class _VitulProfileThreeState extends State<VitulProfileThree> {
