...
class ExploreMatches extends StatefulWidget {
  static const String id = 'ExploreMatches';
  @override
  _ExploreMatchesState createState() => _ExploreMatchesState();
}

class _ExploreMatchesState extends State<ExploreMatches> {
  static final kExploreMatches = Text('Explore Matches',
    style: TextStyle(
