...
class MatchScoringTwo extends StatefulWidget {
  static const String id = 'MatchScoringTwo';
  @override
  _MatchScoringTwoState createState() => _MatchScoringTwoState();
}

class _MatchScoringTwoState extends State<MatchScoringTwo> {
  ...
  static final kMatchScoringText9 = Text('The match time is over.',
    textAlign: TextAlign.center,
    style: TextStyle(
      color: Colors.black,
      fontWeight: FontWeight.w400,
  ...
  static final kMatchScoringText10 = Text('You can start scoring now.',
    textAlign: TextAlign.center,
    style: TextStyle(
      color: Colors.black,
      fontWeight: FontWeight.w400,
  ...
  static final kMatchScoringText8 = Text('MATCH WILL START AT',
    textAlign: TextAlign.center,
    style: TextStyle(
      color: Colors.black,
      fontWeight: FontWeight.w400,
                        ...
                        tiles: [
                          Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                  padding: EdgeInsets.symmetric(horizontal: 40.0),
                                  child: kMatchScoringText9),
                              Padding(
                                  padding: EdgeInsets.symmetric(horizontal: 40.0),
                                  child: kMatchScoringText10),
                              SizedBox(
